...
| 2 | [Họ tên Thành viên 2] | [Điền MSSV] | [Điền Email] | **Data Observability & Corruption Specialist**: Great Expectations 1.x (`quality.py`), Freshness SLA, Tiêm 6 dạng lỗi dữ liệu (`corruption.py`). | `report/<MSSV2>_HoTen.md` |
