...
| 2 | Đào Ngọc Bình Thiên | 2A202602814 | thiendao103@gmail.com | **Data Observability & Corruption Specialist**: Great Expectations 1.x (`quality.py`), Freshness SLA, Tiêm 6 dạng lỗi dữ liệu (`corruption.py`). | `report/2A202602814_DaoNgocBinhThien.md` |
| 3 | [Họ tên Thành viên 3] | [Điền MSSV] | [Điền Email] | **Evaluation, Repair & Reporting Lead**: Sinh test set 10 câu (`testset.py`), Luồng Idempotent Repair (`corruption_flow.py`), Xuất báo cáo đối chiếu 3 trạng thái (`reporting.py`). | `report/<MSSV3>_HoTen.md` |
